    ...
    render() {
        return (
            <header className="page-header">
                <nav>
                    <Link to="/" aria-label="logo" className="logo"> Microservice architecture </Link>
                    ...
                    <ul className="admin-menu">
                        ...
                        {/*<li>*/}
                        {/*    <a href="#0">*/}
                        {/*        <svg id="trends" viewBox="0 0 16 16">*/}
                        {/*            <polygon*/}
                        ...
                        {/*<li>*/}
                        {/*    <a href="#0">*/}
                        {/*        <svg id="comments" viewBox="0 0 16 16">*/}
                        ...
                        {/*<li>*/}
                        {/*    <a href="#0">*/}
                        {/*        <svg id="appearance" viewBox="0 0 16 16">*/}
                        {/*            <path*/}
                        ...
                        {/*<li>*/}
                        {/*    <a href="#0">*/}
                        {/*        <svg id="options" viewBox="0 0 16 16">*/}
                        ...
                        {/*<li>*/}
                        {/*    <a href="#0">*/}
                        {/*        <svg id="charts" viewBox="0 0 16 16">*/}
                        {/*            <polygon*/}
                        ...
                        {/*        <svg aria-hidden="true" id="collapse" viewBox="0 0 16 16">*/}
                        {/*            <polygon*/}
